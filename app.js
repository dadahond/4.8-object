const teams = [{
        name: "FC Barcelona",
        image: "https://upload.wikimedia.org/wikipedia/ru/thumb/2/24/FC_Barcelona.svg/1024px-FC_Barcelona.svg.png",
        stadium: {
            name: "Camp Nou ðŸŸï¸",
            capacity: 99354,
        },
        history: "Founded in 1899 ðŸ†, FC Barcelona is one of the most successful clubs in European football history. Known for its attacking style of play and world-class players.",
        top_scorer: {
    ...
    {
        name: "Real Madrid CF",
        image: "https://upload.wikimedia.org/wikipedia/ru/thumb/8/8a/FC_Real_Madrid_Logo.svg/800px-FC_Real_Madrid_Logo.svg.png",
        stadium: {
            name: "Santiago BernabÃ©u ðŸŸï¸",
            capacity: 81044,
        },
        history: "Founded in 1902 ðŸ†, Real Madrid is one of the most popular and successful football clubs in the world. The club is known for its strong European success.",
        top_scorer: {
    ...
    },
    {
        ...
        image: "https://upload.wikimedia.org/wikipedia/ru/thumb/7/7a/Manchester_United_FC_crest.svg/1024px-Manchester_United_FC_crest.svg.png",
        stadium: {
            name: "Old Trafford ðŸŸï¸",
            capacity: 74879,
        },
        history: "Founded in 1878 ðŸ†, Manchester United is one of the most successful English clubs with a rich history. Known for their iconic 'Class of '92'.",
        top_scorer: {
    ...
    },
    {
        ...
        history: "Founded in 1892 ðŸ†, Liverpool FC is one of the most decorated English clubs. The team is known for its passionate fans and 'You'll Never Walk Alone' anthem.",
        top_scorer: {
            name: "Ian Rush ðŸ‘‘",
            goals: "346 âš½ï¸",
        },
    ...
    {
        name: "Bayern Munich",
        image: "https://upload.wikimedia.org/wikipedia/commons/thumb/1/1b/FC_Bayern_M%C3%BCnchen_logo_%282017%29.svg/1024px-FC_Bayern_M%C3%BCnchen_logo_%282017%29.svg.png",
        stadium: {
            name: "Allianz Arena ðŸŸï¸",
            capacity: 75000,
        },
        history: "Founded in 1900 ðŸ†, Bayern Munich is the most successful German club, known for its dominance in the Bundesliga and European success.",
        top_scorer: {
    ...
    },
    {
        ...
        image: "https://upload.wikimedia.org/wikipedia/ru/thumb/a/a7/Paris_Saint-Germain_F.C..svg/1024px-Paris_Saint-Germain_F.C..svg.png",
        stadium: {
            name: "Parc des Princes ðŸŸï¸",
            capacity: 47929,
        },
        history: "Founded in 1970 ðŸ†, Paris Saint-Germain (PSG) is one of the most successful French clubs, especially in the recent decade.",
        top_scorer: {
    ...
    {
        name: "Juventus FC",
        image: "https://upload.wikimedia.org/wikipedia/commons/thumb/a/a8/Juventus_FC_-_pictogram_black_%28Italy%2C_2017%29.svg/800px-Juventus_FC_-_pictogram_black_%28Italy%2C_2017%29.svg.png",
        stadium: {
            name: "Allianz Stadium ðŸŸï¸",
            capacity: 41507,
        },
        history: "Founded in 1897 ðŸ†, Juventus is the most successful Italian club, known for its success in Serie A and notable players like Alessandro Del Piero.",
        top_scorer: {
    ...
    },
    {
        ...
        image: "https://upload.wikimedia.org/wikipedia/ru/thumb/9/96/Manchester_City_FC.svg/1024px-Manchester_City_FC.svg.png",
        stadium: {
            name: "Etihad Stadium ðŸŸï¸",
            capacity: 53400,
        },
        history: "Founded in 1880 ðŸ†, Manchester City became a major force in English football in the 2010s with the backing of the Abu Dhabi United Group.",
        top_scorer: {
    ...
    {
        name: "Chelsea FC",
        image: "https://upload.wikimedia.org/wikipedia/ru/thumb/f/f7/FC_Chelsea_Logo.svg/1024px-FC_Chelsea_Logo.svg.png",
        stadium: {
            name: "Stamford Bridge ðŸŸï¸",
            capacity: 41837,
        },
        history: "Founded in 1905 ðŸ†, Chelsea became a major force in English football in the 2000s after being purchased by Roman Abramovich.",
        top_scorer: {
    ...
    {
        name: "AC Milan",
        image: "https://upload.wikimedia.org/wikipedia/commons/thumb/d/d0/Logo_of_AC_Milan.svg/800px-Logo_of_AC_Milan.svg.png",
        stadium: {
            name: "San Siro ðŸŸï¸",
            capacity: 80018,
        },
        history: "Founded in 1899 ðŸ†, AC Milan is one of the most successful Italian clubs, known for its European success in the 1990s.",
        top_scorer: {
    ...
    },
    {
        ...
        image: "https://upload.wikimedia.org/wikipedia/ru/thumb/0/01/FC_Atletico_Madrid_Logo.svg/800px-FC_Atletico_Madrid_Logo.svg.png",
        stadium: {
            name: "Wanda Metropolitano ðŸŸï¸",
            capacity: 68456,
        },
        history: "Founded in 1903 ðŸ†, AtlÃ©tico Madrid is known for its resilient defense and passionate supporters. One of the most successful Spanish clubs.",
        top_scorer: {
    ...
    {
        name: "Inter Milan",
        image: "https://upload.wikimedia.org/wikipedia/commons/thumb/0/05/FC_Internazionale_Milano_2021.svg/1024px-FC_Internazionale_Milano_2021.svg.png",
        stadium: {
            name: "San Siro ðŸŸï¸",
            capacity: 80018,
        },
        history: "Founded in 1908 ðŸ†, Inter Milan is one of the most successful Italian clubs, known for its rivalry with AC Milan and its European triumphs.",
        top_scorer: {
    ...
    {
        name: "Ajax Amsterdam",
        image: "https://upload.wikimedia.org/wikipedia/ru/thumb/7/79/Ajax_Amsterdam.svg/1024px-Ajax_Amsterdam.svg.png",
        stadium: {
            name: "Johan Cruyff Arena ðŸŸï¸",
            capacity: 55000,
        },
        history: "Founded in 1900 ðŸ†, Ajax is the most successful Dutch club, known for its youth academy and 'Total Football' philosophy.",
        top_scorer: {
    ...
    },
    {
        ...
        history: "Founded in 1909 ðŸ†, Borussia Dortmund is known for its passionate fans and attacking football. The club has a rich history in German football.",
        top_scorer: {
    ...
    },
    {
        ...
        image: "https://upload.wikimedia.org/wikipedia/ru/thumb/b/b4/Tottenham_Hotspur.svg/800px-Tottenham_Hotspur.svg.png",
        stadium: {
            name: "Tottenham Hotspur Stadium ðŸŸï¸",
            capacity: 62850,
        },
        history: "Founded in 1882 ðŸ†, Tottenham Hotspur is a prominent English club, known for its attacking football and fierce rivalry with Arsenal.",
        top_scorer: {
            name: "Harry Kane ðŸ‘‘",
            goals: "280 âš½ï¸",
        },
    ...
    {
        name: "AS Roma",
        image: "https://upload.wikimedia.org/wikipedia/ru/thumb/f/f7/AS_Roma_logo_%282017%29.svg/800px-AS_Roma_logo_%282017%29.svg.png",
        stadium: {
            name: "Stadio Olimpico ðŸŸï¸",
            capacity: 72698,
        },
        history: "Founded in 1927 ðŸ†, AS Roma is a historic club from Italy, known for its passionate fanbase and rivalry with Lazio.",
        top_scorer: {
    ...
    {
        name: "SL Benfica",
        image: "https://upload.wikimedia.org/wikipedia/ru/thumb/6/6a/SL_Benfica_Logo.svg/1024px-SL_Benfica_Logo.svg.png",
        stadium: {
            name: "EstÃ¡dio da Luz ðŸŸï¸",
            capacity: 64642,
        },
        history: "Founded in 1904 ðŸ†, SL Benfica is the most successful club in Portugal, known for its dominance in the Primeira Liga.",
        top_scorer: {
            name: "EusÃ©bio ðŸ‘‘",
            goals: "473 âš½ï¸",
        },
    ...
    {
        name: "Porto FC",
        image: "https://upload.wikimedia.org/wikipedia/ru/thumb/f/f1/FC_Porto.svg/800px-FC_Porto.svg.png",
        stadium: {
            name: "EstÃ¡dio do DragÃ£o ðŸŸï¸",
            capacity: 50033,
        },
        history: "Founded in 1893 ðŸ†, Porto FC is one of Portugalâ€™s 'Big Three' clubs and has achieved great success domestically and in European competitions.",
        top_scorer: {
    ...
    {
        name: "Lazio",
        image: "https://upload.wikimedia.org/wikipedia/ru/thumb/7/78/FC_Lazio_Logo.svg/1024px-FC_Lazio_Logo.svg.png",
        stadium: {
            name: "Stadio Olimpico ðŸŸï¸",
            capacity: 72698,
        },
        history: "Founded in 1900 ðŸ†, Lazio is one of Italyâ€™s oldest and most historic clubs, with a fierce rivalry with AS Roma.",
        top_scorer: {
    ...
    {
        name: "Napoli",
        image: "https://upload.wikimedia.org/wikipedia/commons/thumb/0/00/SSC_Napoli_2024_%28deep_blue_navy%29.svg/1200px-SSC_Napoli_2024_%28deep_blue_navy%29.svg.png",
        stadium: {
            name: "Stadio Diego Armando Maradona ðŸŸï¸",
            capacity: 54726,
        },
        history: "Founded in 1926 ðŸ†, Napoli is one of Italy's most iconic clubs, known for its passionate fan base and historic success, particularly during the Maradona era.",
        top_scorer: {
